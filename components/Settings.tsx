...
import { User, LogIn, LogOut, Database, UserCircle, UserPlus, Lock, Mail, AlertCircle, Download, Upload } from 'lucide-react';
  ...
  return (
    <div className="pb-24">
      ...
      <div className="space-y-3">
        ...
        <button className="w-full bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex items-center justify-between group active:scale-[0.99] transition">
          <div className="flex items-center gap-3 text-gray-700">
            <UserCircle size={20} />
            <span>프로필 수정</span>
          </div>
          <span className="text-gray-300 text-sm">준비 중</span>
        </button>
      ...
      <div className="mt-12 text-center">
        <p className="text-xs text-gray-400">OKR 플래너 v1.1.0</p>
